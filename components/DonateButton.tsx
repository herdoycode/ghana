...
const DonateButton = () => {
  return (
    <Link
      ...
      target="blank"
    >
      <div className="group flex items-center dark:border-primary max-w-fit rounded-[30px] ps-2 hover:text-white hover:bg-primary transition-all border-primary border-2 hover:border-white">
